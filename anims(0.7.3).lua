...
local mainFrame = imgui.OnFrame(
    ...
    function(player)
		...
		if imgui.Button('Stop anim', btn_size) and animStatus and not isCharInAnyCar(PLAYER_PED) and not sampIsChatInputActive() then
	...
	if renderDanceWindow[0] then
		...
		imgui.SetNextWindowSize(imgui.ImVec2(220, 225), imgui.Cond.FirstUseEver)
